...
scApp.directive('scorecard', function() {
	return {
		restrict : 'E',
		templateUrl : 'scorecard.html?version=R2.2'
	};
});
...
scApp.directive('debug', function() {
	return {
		restrict : 'E',
		templateUrl : 'debug.html?version=R2.2'
	};
});
...
scApp.directive('topLevelResults', function() {
	return {
		restrict : 'E',
		templateUrl : 'topLevelResults.html?version=R2.2'
	};
});
...
scApp.directive('summary', function() {
	return {
		restrict : 'E',
		templateUrl : 'summary.html?version=R2.2'
	};
});
...
scApp.directive('heatMap', function() {
    return {
        restrict : 'E',
        templateUrl : 'heatMap.html?version=R2.2'
    };
});
...
scApp.directive('detailedResults', function() {
	return {
		restrict : 'E',
		templateUrl : 'detailedResults.html?version=R2.2'
	};
});
...
scApp.directive('scorecardTwoResults', function() {
	return {
		restrict : 'E',
		templateUrl : 'scorecardTwoResults.html?version=R2.2'
	};
});
...
scApp.directive('compare', function() {
    return {
    	restrict: 'E',
    	templateUrl: 'compare.html?version=R2.2'
    };
});
...
scApp.directive('saveScorecardButton', function() {
	return {
		restrict: 'E',
		templateUrl: 'saveScorecardButton.html?version=R2.2'
	};
});
...
scApp.directive('saveTryMeXmlButton', function() {
	return {
		restict: 'E',
		templateUrl: 'saveTryMeXmlButton.html?version=R2.2'
	};
});
...
scApp.directive('siteHeader', function() {
	return {
		restrict : 'E',
		templateUrl : 'siteHeader.html?version=R2.2'
	};
});
...
scApp.directive('siteNavbar', function() {
	return {
		restrict : 'E',
		templateUrl : 'siteNavbar.html?version=R2.2'
	};
});
...
scApp.directive('siteTopLevelContent', function() {
	return {
		restrict : 'E',
		templateUrl : 'siteTopLevelContent.html?version=R2.2'
	};
});
...
scApp.directive('siteUploadForm', function() {
	return {
		restrict : 'E',
		templateUrl : 'siteUploadForm.html?version=R2.2'
	};
});
...
scApp.directive('siteResultsModal', function() {
	return {
		restrict : 'E',
		templateUrl : 'siteResultsModal.html?version=R2.2'
	};
});
...
scApp.directive('siteFooter', function() {
	return {
		restrict : 'E',
		templateUrl : 'siteFooter.html?version=R2.2'
	};
});
...
scApp.directive('siteScoringCriteriaModal', function() {
	return {
		restrict : 'E',
		templateUrl : 'siteScoringCriteriaModal.html?version=R2.2'
	};
});
...
scApp.directive('siteApiInstructionsModal', function() {
	return {
		restrict : 'E',
		templateUrl : 'siteApiInstructionsModal.html?version=R2.2'
	};
});
...
scApp.directive('siteIntroductionModal', function() {
	return {
		restrict: 'E',
		templateUrl: 'siteIntroductionModal.html?version=R2.2'
	};
});
...
scApp.directive('siteDownloadLocalModal', function() {
	return {
		restrict: 'E',
		templateUrl: 'siteDownloadLocalModal.html?version=R2.2'
	};
});
...
scApp.directive('linkDisclaimer', function() {
	return {
		...
		templateUrl: 'siteExternalLinkDisclaimer.html?version=R2.2'
	};
});
